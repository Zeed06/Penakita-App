...
function ParagraphRendererComponent({ paragraph, index }: ParagraphRendererProps) {
  ...
  switch (type) {
    case 'H1':
      return (
        <Text className="text-2xl font-bold text-ink mt-6 mb-3 leading-tight">
    ...
    case 'H2':
      return (
        <Text className="text-xl font-semibold text-ink mt-5 mb-2 leading-tight">
          <MarkupText text={text} markups={markups} />
        </Text>
      );
      ...
      return (
        <View className="my-2">
          <MarkupText
            text={text}
            markups={markups}
            className="text-base text-ink leading-7"
          />
        </View>
      );
      ...
      return (
        <View className="border-l-4 border-primary-500 pl-4 my-4 bg-surface-secondary py-2 rounded-r-sm">
          <MarkupText
            text={text}
            markups={markups}
            className="text-base italic text-ink-secondary leading-6"
          />
        </View>
      );
      ...
      return (
        <View className="border-l-4 border-surface-tertiary pl-4 my-4">
          <MarkupText
            text={text}
            markups={markups}
            className="text-base text-ink-tertiary leading-6"
          />
        </View>
      );
